...
public class PrimeNumberGenerator {
    ...
    private static marker[] crossedOut;      // is the number crossed out?
    private static int[] primes;             // array to store all the prime numbers
    
    public static int[] generatePrimeNumbersTo(int limit) {
        if(limit < 2) {
            return new int[0];
        } else {
